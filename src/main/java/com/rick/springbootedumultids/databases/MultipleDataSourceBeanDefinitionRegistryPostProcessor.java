package com.rick.springbootedumultids.databases;
 ...
 * 方法的执行顺序是：setEnvironment()-->postProcessBeanDefinitionRegistry() --> postProcessBeanFactory()
 * User : RICK
 * Time : 2017/8/25 17:23
 */
@Configuration
